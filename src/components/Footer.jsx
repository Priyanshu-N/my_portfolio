...
const Footer = () => {
  return (
    <footer className='bg-black text-white py-16 px-6 mt-40'>
        <div className='max-w-6xl mx-auto'>
            <div className='flex justify-between items-center'>
                ...
                <h2 className='text-3xl font-bold bg-gradient-to-r from-purple-400
                 ...
                 {/* SCROLL LINKS  */}
                 <div>
                    <h3 className='text-xl font-semibold mb-4 text-purple-200'>Connect</h3>
        ...
        <div className='border-t border-gray-700 mt-12 pt-8 flex flex-col justify-between md:flex-row  items-center'>
            <p className='text-gray-500 text-sm'>
                © 2025 PriyanshuCode. All rights reserved.
            </p>

...
const ContactSection = () => {
  ...
  useEffect(()=> {
    ...
    // make sure all surroundings instances are properly killed 
      ...
      style={{ overscrollBehavior: "none"}}>
        ...
        <div 
          ...
          bg-gradient-to-r from-violet-400 to-pink-100'>
            ...
            <p ref={initialTextRef} className=" text-black font-bold text-base sm:text-lg
            ...
            <div 
              ...
              >
                ...
                sm:mt-3 mt-1 md:scale-[0.1] scale-[0.068]">
                  Front-end developer sepcialized in crafting modern,
                  responsive web interfaces using React, Tailwind CSS,
                  and advanced UI animation techniques. Focused on clean
                  code, and pixel-perfect design that stand out.
                </p>

                <button className="px-10 py-2 rounded-xl bg-black
                hover:bg-white hover:text-black transition-all duration-500
                scale-[0.1] absolute sm:mt-9 mt-7 text-nowrap">Contact Me</button>
            </div>
